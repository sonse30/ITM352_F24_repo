...
total_fare = 0.00
minimum_fare = float('inf')  # Set to infinity to ensure the first comparison works
    ...
    for line in csv_reader:
        ...
        if line_number > 0:
            try:
                ...
                # Update total fare and fare count
                total_fare += fare
                valid_fare_count += 1
...
if valid_fare_count > 0:
    ...
    print(f"The total of all fares is: ${total_fare:.2f}")
    print(f"The average fare is: ${average_fare:.2f}")
    print(f"The minimum fare is: ${minimum_fare:.2f}")
    print(f"The maximum trip distance was {maximum_trip_distance:.2f} miles")
else:
    print("No valid fares were found.")
